...
def generate_launch_description():
    ...
    map_dir = LaunchConfiguration(
        "map",
        default=os.path.join("/home/roboticsinnovatorytim/isaac_tutorial/examples/sim/IsaacSim-ros_workspaces/humble_ws/src/navigation/carter_navigation/maps/homework.yaml"),
    )

    param_dir = LaunchConfiguration(
        "params_file",
        default=os.path.join("/home/roboticsinnovatorytim/isaac_tutorial/examples/sim/IsaacSim-ros_workspaces/humble_ws/src/navigation/carter_navigation/params/homework.yaml"),
    )
